    ...
    public void run() {
        ...
        while (url != null) try {
            ...
            if (Main.pageCount % 500 == 0) {
                ...
                System.out.println("500 pages, count:" + Main.pageCount + "@ " + (Calendar.getInstance().get(Calendar.SECOND)) + " s, cur fetcher:: " + Main.currentThreadNum + " cur parser: " + Main.currentParseThreadNum);
            }
